...
const Navbar = () => {
  return (
    <header className="bg-white">
      <nav className="max-w-[60%] mx-auto py-6 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <Select defaultValue="M21Kitchen">
            <SelectTrigger className="w-[160px]">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="M21Kitchen">M21 Kitchen</SelectItem>
              <SelectItem value="BroadwayPizza">Broadway Pizza</SelectItem>
              <SelectItem value="RollersPizza">Rollers Pizza</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div className="flex items-center space-x-2">
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <Link href={"/"}>
                <ShoppingBasket className="w-[20px]" />
              </Link>
              <span className="absolute top-[-15px] right-[-15px] w-6 h-6 bg-orange-500 text-white rounded-full text-[12px] flex justify-center items-center">
                3
              </span>
            </div>
          </div>
